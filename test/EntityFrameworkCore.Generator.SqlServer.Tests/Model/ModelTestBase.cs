...
/// live SQL Server schema created for the integration suite. The schema is read once with
/// <see cref="SqlServerSchemaReader"/> and shared across the test collection; each test maps
...
public abstract class ModelTestBase : DatabaseTestBase
{
    ...
    /// <summary>
    /// Reads the live SQL Server schema once and caches it for the duration of the test run.
    /// </summary>
    ...
    /// </summary>
    protected static Entity GetEntity(EntityContext context, string tableName, string schema = "dbo")
    {

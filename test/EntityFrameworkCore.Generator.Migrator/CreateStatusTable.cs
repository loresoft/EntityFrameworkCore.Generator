...
[Migration(2026010104)]
public class CreateStatusTable : Migration
{
    private readonly IProviderDefault _providerDefault;

    public CreateStatusTable(IProviderDefault providerDefault)
    {
    ...
    {
        Delete.Table("Status").InSchema(DefaultSchema);
    }
}

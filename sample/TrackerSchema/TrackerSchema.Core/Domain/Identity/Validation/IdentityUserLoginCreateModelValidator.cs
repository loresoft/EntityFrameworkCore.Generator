...
{
    /// <summary>
    /// Validator class for <see cref="IdentityUserLoginCreateModel"/> .
    /// </summary>
    public partial class IdentityUserLoginCreateModelValidator
        : AbstractValidator<IdentityUserLoginCreateModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityUserLoginCreateModelValidator"/> class.
        /// </summary>
        public IdentityUserLoginCreateModelValidator()
        {
